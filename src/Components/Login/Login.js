...
import image1 from "../../image/undraw_login_re_4vu2.svg";
...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 my-28 bg-[#EDEDED] py-16">
      <div>
        <img className="w-3/4 mx-auto mt-28" src={image1} alt="" />
      </div>
      <div className="w-3/5 mt-20">
        <div className="card mx-auto shadow-2xl mt-[-120px]">
